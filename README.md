...
- [X] Solve Mountain Car with Genetic Algorithms (this environment is more challenging than it seems)
- [X] Try again Bipedal Walker with the Genetic Algorithm. Get's a better performance although it is not optimal
